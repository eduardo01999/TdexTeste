...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Abr-2023 às 21:50
...
CREATE TABLE `multa` (
  ...
  `orgao` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `valor` double(10,2) NOT NULL,
  `quitacao` tinyint(1) NOT NULL DEFAULT 0,
  `quitacao_hora` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
ALTER TABLE `multa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `multa_veiculo_id_foreign` (`veiculo_id`);
...
ALTER TABLE `veiculo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `veiculo_empresa_id_foreign` (`empresa_id`);
...
--
ALTER TABLE `multa`
  ADD CONSTRAINT `multa_veiculo_id_foreign` FOREIGN KEY (`veiculo_id`) REFERENCES `veiculo` (`id`);

--
-- Limitadores para a tabela `veiculo`
--
ALTER TABLE `veiculo`
  ADD CONSTRAINT `veiculo_empresa_id_foreign` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id`);
COMMIT;
